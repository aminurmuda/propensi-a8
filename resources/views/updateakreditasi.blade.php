            ...
            <div class="db-wrapper">
                ...
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                         ...
                         @if($akreditasi_prodi -> nilai == NULL || $role=='Admin')
                         <td><input type="number" class="form-control" id="nilai_akreditasi" name="nilai_akreditasi" value="{{$akreditasi_prodi -> nilai}}"></td>
                         @else
                         <td><input type="number" class="form-control" id="nilai_akreditasi" name="nilai_akreditasi" value="{{$akreditasi_prodi -> nilai}}" readonly="readonly"></td>
                         @endif
                    </tr>
                    <tr>
