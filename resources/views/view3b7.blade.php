         ...
         7.1 Penelitian
                    ...
                    <div id="one" class="panel-collapse collapse">
                        <div class="panel-body">
                           ...
                           <a href="{{ url('3b/standar7edit/7-1-2/'.$idHistori) }}" class="btn-primary btn-lg pull-right glyphicon glyphicon-pencil"> Edit</a>
                           @endif
                           @endif
                           ...
                           <br><br><h3>Komentar: </h3>
                            ...
                            @if($status==1 || $role=='Admin')
                             <form action="{{url('3b/standar7/7-1/'.$kodeProdi.'/'.$idHistori.'/3B/submitkomentar')}}">
                              {{csrf_field()}}
                            ...
                            @endif
                             ...
                             <!-- komentar -->
                            <br>
                            @if(count($komentar7_1)>0)<br><br>@foreach($komentar7_1 as $komentar7_1)
                            <div class="row">
                              <div class="col-sm-2">
                              <div class="thumbnail">
                    ...
                    <div id="two" class="panel-collapse collapse">
                        <div class="panel-body">
                           ...
                           <div style="width:850px;height:200px;line-height:3em;overflow:scroll;padding:5px;background-color:#edeef9;color:#000000;scrollbar-base-color:#DEBB07;">
                             ...
                             @if($role=='Tim Akreditasi' || $role=='Admin' )
                             @if($status==0 || $role=='Admin')
                           <a href="{{ url('3b/standar7edit/7-2-2/'.$idHistori) }}" class="btn-primary btn-lg pull-right glyphicon glyphicon-pencil"> Edit</a>
                           @endif
                           @endif
                           ...
                           <br><br><h3>Komentar: </h3>
                            ...
                            <div>
                            @if($status==1 || $role=='Admin')
                             <form action="{{url('3b/standar7/7-2/'.$kodeProdi.'/'.$idHistori.'/3B/submitkomentar')}}">
                              {{csrf_field()}}
                              <div class="form-group">
                                <textarea class="form-control" id='isi-komentar' name='isi-komentar'>
                            ...
                            @endif
                             ...
                             <!-- komentar -->
                            <br>
                            @if(count($komentar7_2)>0)<br><br>@foreach($komentar7_2 as $komentar7_2)
                            <div class="row">
                              <div class="col-sm-2">
                              <div class="thumbnail">
                              <img class="img-responsive user-photo" src="https://ssl.gstatic.com/accounts/ui/avatar_2x.png">
