...
@section('content')
    ...
    <div class="container">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <h3>Ubah Borang 3A, Standar 2</h3>
            <span> Tata Pamong, Kepemimpinan, Sistem Pengelolaan, dan Penjaminan Mutu </span>
            <a href="{{ url('3a/standar2/'.$kode_fakultas) }}" class="btn-primary btn-lg pull-right glyphicon glyphicon-pencil"> Simpan</a>
                    ...
                    <div id="five" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Dosen</td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Dosen']['Isi Umpan Balik'] }}</textarea></td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Dosen']['Tindak Lanjut'] }}</textarea></td>
                                </tr>
                                <tr>
                                    <td>Mahasiswa</td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Mahasiswa']['Isi Umpan Balik'] }}</textarea></td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Mahasiswa']['Tindak Lanjut'] }}</textarea></td>
                                </tr>
                                <tr>
                                    <td>Alumni</td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Alumni']['Isi Umpan Balik'] }}</textarea></td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Alumni']['Tindak Lanjut'] }}</textarea></td>
                                </tr>
                                <tr>
                                    <td>Pengguna lulusan</td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Pengguna lulusan']['Isi Umpan Balik'] }}</textarea></td>
                                    <td><textarea >{{ $standar2['standar2']['2.5']['isian']['Pengguna lulusan']['Tindak Lanjut'] }}</textarea></td>
                                </tr>
                            </table>
