...
class Akreditasi extends Model
{
        ...
        public static function getAkreditasi($tahun,$kode_prodi)
    {
        return DB::table('histori_akreditasi')
            ...
            ->select('histori_akreditasi.nilai','histori_akreditasi.peringkat_akreditasi','histori_akreditasi.keterangan','histori_akreditasi.tahun_keluar','histori_akreditasi.masa_berlaku','status.nama as nama_status', 'program_studi.nama_prodi','fakultas.nama_fakultas')
    ...
    public static function getAllAkreditasi($kode_fakultas)
    {
        return DB::table('histori_akreditasi')
            ...
            ->join('program_studi', 'histori_akreditasi.kode_prodi', '=', 'program_studi.kode_prodi')
          //  ->join('fakultas','program_studi.kode_fakultas','=','fakultas.kode_fakultas')
            ->select('histori_akreditasi.nilai','histori_akreditasi.peringkat_akreditasi','histori_akreditasi.keterangan','histori_akreditasi.tahun_keluar','histori_akreditasi.masa_berlaku','status.nama as nama_status', 'program_studi.nama_prodi')
