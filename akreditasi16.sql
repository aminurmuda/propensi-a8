...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2017 at 09:19 AM
...
INSERT INTO `proyek` (`id`, `status`, `id_pengaju`, `id_jenis_proyek`, `id_dosen`, `lokasi`, `tanggal_mulai`, `tanggal_selesai`, `dana_internal`, `dana_eksternal`, `mitra`, `rumpun_ilmu`, `nama`, `id_jenis_luaran`, `tingkat`) VALUES
(1, 'NULL', 0, 0, 14, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2011, 2014, 0, 0, 'NULL', 'NULL', 'Kemampuan Kreativitas Sumber Daya Manusia Terhadap Mot', 1, 'Lokal'),
(2, 'NULL', 0, 0, 15, 'Perpustakaan Pusat', 2011, 2014, 0, 0, 'NULL', 'NULL', 'Sistem Persamaan Linear dan Metode penyelesaiannya', 1, 'Nasional'),
(3, 'NULL', 0, 0, 16, 'Digital Library', 2011, 2014, 0, 0, 'NULL', 'NULL', 'Pengaruh IT dengan kemajuan ekonomi bangsa', 1, 'Internasional'),
(4, 'NULL', 0, 0, 17, 'Digital Library', 2011, 2014, 0, 0, 'NULL', 'NULL', 'E-commerce masa kini', 1, 'Internasional'),
(5, 'NULL', 0, 0, 18, 'Perpustakaan Pusat', 2011, 2014, 0, 0, 'NULL', 'NULL', 'Perkembangan e-health management', 1, 'Nasional'),
(6, 'NULL', 0, 0, 19, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2011, 2014, 0, 0, 'NULL', 'NULL', 'Implementasi knowledge Management terhadap kantor peme', 1, 'Lokal'),
(7, 'NULL', 0, 0, 20, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2011, 2014, 0, 0, 'NULL', 'NULL', 'Hubungan smart city dengan Indonesia', 1, 'Lokal'),
(8, 'NULL', 0, 0, 21, 'Perpustakaan Pusat', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Dampak persebaran penduduk di Kalimantan terhadap kema', 1, 'Nasional'),
(9, 'NULL', 0, 0, 22, 'Digital Library', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Implementasi knowledge Management terhadap sistem peru', 1, 'Internasional'),
(10, 'NULL', 0, 0, 23, 'Digital Library', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Teknik pembuatan biogas', 1, 'Internasional'),
(11, 'NULL', 0, 0, 24, 'Perpustakaan Pusat', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Kemampuan Kreativitas Sumber Daya Manusia Terhadap IT ', 1, 'Nasional'),
(12, 'NULL', 0, 0, 25, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Kemajuan sistem Koperasi Indonesia', 1, 'Lokal'),
(13, 'NULL', 0, 0, 26, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Hubungan antara keamanan e-payment dengan loyalitas ko', 1, 'Lokal'),
(14, 'NULL', 0, 0, 27, 'Perpustakaan Pusat', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Aplikasi Pemesanan Rental Mobil Hafa Yogyakarta Dengan', 1, 'Nasional'),
(15, 'NULL', 0, 0, 28, 'Digital Library', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Analisis dan Perancangan Sistem Informasi Pemasaran da', 5, 'Internasional'),
(16, 'NULL', 0, 0, 29, 'Digital Library', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Perancangan Perangkat Lunak Tender untuk Jasa Konsulta', 5, 'Internasional'),
(17, 'NULL', 0, 0, 30, 'Perpustakaan Pusat', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Deteksi Muka Depan Manusia dari Sebuah Citra Berwarna ', 5, 'Nasional'),
(18, 'NULL', 0, 0, 31, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2012, 2015, 0, 0, 'NULL', 'NULL', 'Perangkat Lunak Sistem Informasi Pegawai PT. Stannia B', 5, 'Lokal'),
(19, 'NULL', 0, 0, 32, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Perangkat Lunak Pemenuhan Kebutuhan Gizi pada Orang Sa', 5, 'Lokal'),
(20, 'NULL', 0, 0, 33, 'Perpustakaan Pusat', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Analisa & Perancangan Sistem Monitoring Inventaris Bar', 5, 'Nasional'),
(21, 'NULL', 0, 0, 34, 'Digital Library', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Implementasi SMS gateway dengan menggunakan bahasa ala', 5, 'Internasional'),
(22, 'NULL', 0, 0, 35, 'Digital Library', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Studi dan Implementasi Konsep Business to Costumer den', 5, 'Internasional'),
(23, 'NULL', 0, 0, 36, 'Perpustakaan Pusat', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Perancangan Sistem Informasi Berbasis Web pada Perpust', 5, 'Nasional'),
(24, 'NULL', 0, 0, 37, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Sistem Aplikasi Try Out SPMB dan EBTANAS Berbasis Web ', 5, 'Lokal'),
(25, 'NULL', 0, 0, 38, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Aplikasi Logika Fuzzy untuk Prediksi Penyakit dengan M', 5, 'Lokal'),
(26, 'NULL', 0, 0, 39, 'Perpustakaan Pusat', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Sistem Informasi Eksekutif untuk Perencanaan Tata Leta', 8, 'Nasional'),
(27, 'NULL', 0, 0, 40, 'Digital Library', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Membangun Aplikasi Pustaka (Pusat Data Informatika) Be', 8, 'Internasional'),
(28, 'NULL', 0, 0, 41, 'Digital Library', 2013, 2016, 0, 0, 'NULL', 'NULL', 'Aplikasi Algoritma Minimax pada Permainan Checkers', 8, 'Internasional'),
(29, 'NULL', 0, 0, 42, 'Perpustakaan Pusat', 2014, 2017, 0, 0, 'NULL', 'NULL', 'Sistem Pendukung Keputusan Penentuan Porsi Dana Invest', 8, 'Nasional'),
(30, 'NULL', 0, 0, 43, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2014, 2017, 0, 0, 'NULL', 'NULL', 'Rancang Bangun Multiplayer Game Real Time Strategy Ber', 8, 'Lokal'),
(31, 'NULL', 0, 0, 44, 'Jurnal Baca (Pusat Kajian Lembaga Penelitian Universitas Pepabri Makasar)', 2014, 2017, 0, 0, 'NULL', 'NULL', 'Menentukan Volume Produksi dengan Menggunakan Metode S', 8, 'Lokal'),
(32, 'NULL', 0, 0, 45, 'Perpustakaan Pusat', 2014, 2017, 0, 0, 'NULL', 'NULL', 'Sistem Informasi dan Analisa Akuntansi di PT. Prima Ci', 8, 'Nasional'),
(33, 'NULL', 0, 0, 46, 'Digital Library', 2014, 2017, 0, 0, 'NULL', 'NULL', 'Penentuan Lokasi Optimal untuk Distribusi Unit Pelayan', 8, 'Internasional'),
(34, 'NULL', 0, 0, 47, 'Digital Library', 2014, 2017, 0, 0, 'NULL', 'NULL', 'Rancang Bangun Sistem Informasi Geografis Daerah Pariw', 8, 'Internasional');
