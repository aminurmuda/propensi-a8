...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2017 at 10:03 AM
...
CREATE TABLE `histori_akreditasi` (
  ...
  `kode_prodi` varchar(30) NOT NULL,
  `id_borang_3A_2` varchar(10) DEFAULT NULL,
  `id_borang_3A_4` varchar(10) DEFAULT NULL,
  `id_borang_3A_7` varchar(10) DEFAULT NULL,
  `id_borang_3B_2` varchar(10) DEFAULT NULL,
  `id_borang_3B_4` varchar(10) DEFAULT NULL,
  `id_borang_3B_7` varchar(10) DEFAULT NULL,
  `id_borang_ED` varchar(10) DEFAULT NULL,
...
INSERT INTO `histori_akreditasi` (`id`, `nilai`, `peringkat_akreditasi`, `keterangan`, `tahun_keluar`, `masa_berlaku`, `kode_prodi`, `id_borang_3A_2`, `id_borang_3A_4`, `id_borang_3A_7`, `id_borang_3B_2`, `id_borang_3B_4`, `id_borang_3B_7`, `id_borang_ED`, `status`) VALUES
(1, NULL, NULL, NULL, '2017', NULL, '1', '1', '2', '3', '10', '9', '8', NULL, 1),
(2, NULL, NULL, NULL, '2017', NULL, '2', '4', '5', '6', NULL, NULL, NULL, NULL, 1);
...
CREATE TABLE `pegawai` (
  ...
  `id_prodi_reviewer` varchar(30) NOT NULL,
...
(4, 'muchamad.lutfi', '567', '1406623152', 'Lutfi Maulana', NULL, NULL, NULL, NULL, 'F87648E2873', '1986-04-01', NULL, NULL, NULL, NULL, NULL, 1, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 1, 1, 0, 0, '0', '2017-04-19 12:35:12', '2017-05-10 07:53:07', 0),
...
(77, 'Ahmad.Elang', '403181', '1464529385', 'Ahmad Elang', NULL, NULL, NULL, NULL, '882-17-8833', '1982-04-15', NULL, NULL, NULL, NULL, NULL, 1, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, 0, 0, 1, '1', '2017-04-19 12:35:15', '2017-05-10 07:48:12', 0),
...
ALTER TABLE `histori_akreditasi`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kode_prodi` (`kode_prodi`),
  ADD KEY `id_borang` (`id_borang_3A_2`),
  ADD KEY `id_borang_3B` (`id_borang_3B_2`),
  ADD KEY `id_borang_ED` (`id_borang_ED`),
  ADD KEY `id_borang_3A_4` (`id_borang_3A_4`),
  ADD KEY `id_borang_3A_7` (`id_borang_3A_7`),
  ADD KEY `id_borang_3B_4` (`id_borang_3B_4`),
  ADD KEY `id_borang_3B_7` (`id_borang_3B_7`);
...
ALTER TABLE `histori_akreditasi`
  ...
  ADD CONSTRAINT `histori_akreditasi_ibfk_2` FOREIGN KEY (`id_borang_3A_2`) REFERENCES `borang` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `histori_akreditasi_ibfk_3` FOREIGN KEY (`id_borang_3B_2`) REFERENCES `borang` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `histori_akreditasi_ibfk_4` FOREIGN KEY (`id_borang_ED`) REFERENCES `borang` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `histori_akreditasi_ibfk_5` FOREIGN KEY (`id_borang_3A_4`) REFERENCES `borang` (`id`),
  ADD CONSTRAINT `histori_akreditasi_ibfk_6` FOREIGN KEY (`id_borang_3A_7`) REFERENCES `borang` (`id`),
  ADD CONSTRAINT `histori_akreditasi_ibfk_7` FOREIGN KEY (`id_borang_3B_4`) REFERENCES `borang` (`id`),
  ADD CONSTRAINT `histori_akreditasi_ibfk_8` FOREIGN KEY (`id_borang_3B_7`) REFERENCES `borang` (`id`);
