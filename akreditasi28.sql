...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Apr 2017 pada 16.45
...
--
-- Struktur dari tabel `kelola_akreditasi`
--
...
(3, 'gemma.adhatien', '456', '1406574895', 'Gemma Adhatien', NULL, NULL, NULL, NULL, 'H637808348', '1984-03-01', NULL, NULL, NULL, NULL, NULL, 1, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0, '2017-04-19 12:35:12', '2017-04-24 07:08:07', 1),
...
--
-- Ketidakleluasaan untuk tabel `borang`
--
ALTER TABLE `borang`
...
--
-- Ketidakleluasaan untuk tabel `kelola_akreditasi`
--
ALTER TABLE `kelola_akreditasi`
...
--
-- Ketidakleluasaan untuk tabel `program_tugas_dosen`
--
ALTER TABLE `program_tugas_dosen`
...
--
-- Ketidakleluasaan untuk tabel `rincian_kinerja_pengajaran`
--
ALTER TABLE `rincian_kinerja_pengajaran`
